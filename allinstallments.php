              ...
              <div class="card">
                ...
                <div class="card-body">
                  <!-- <table id="demo-datatables-buttons-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%"> -->
                    ...
                    $query="SELECT soldcars.chasis,vehicles.vname,vehicles.regno,installments.amountpaid,installments.datepaid, installments.reference FROM soldcars JOIN installments ON installments.chasis= soldcars.chasis JOIN vehicles ON soldcars.chasis= vehicles.chasis ORDER BY installments.datepaid DESC";
