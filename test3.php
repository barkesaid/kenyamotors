...
<head>
    ...
    <title>DataTables buttons &middot; Elephant Template &middot; The fastest way to build modern admin site for any platform, browser, or device</title>
              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav active">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li class="active"><a href="datatables-buttons.html">Datatables Buttons</a></li>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="demo-datatables-buttons-2" class="table table-bordered table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    $query="SELECT vehicles.vname,soldcars.datesold,vehicles.regno,soldcars.sellingprice,soldcars.id FROM vehicles INNER JOIN soldcars ON vehicles.chasis=soldcars.chasis ORDER BY `soldcars`.`datesold` DESC";
