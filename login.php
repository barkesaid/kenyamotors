          ...
          <div class="title-bar">           
            ...
            <div class="col-md-9">
              <div class="demo-form-wrapper">
                <form class="form form-horizontal" action="login1.php" method="POST" autocomplete="off">
                  <div class="form-group">
                    <div class="form-group">
                    <label class="col-sm-3 control-label" for="form-control-3">Username </label> 
                    <div class="col-sm-9"> 
                    <input id="form-control-3" class="form-control" type="text" name="username" required>                   
                     </div>
                  </div> <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="password" name="password"  required/>
                    </div>
                  </div> <br>
