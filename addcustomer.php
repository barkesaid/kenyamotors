          ...
          <div class="title-bar">           
            ...
            <div class="col-md-9">
              <div class="demo-form-wrapper">
                <form class="form form-horizontal" action="postcustomer.php" method="POST">
                  <div class="form-group">
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="form-control-3">National Id No </label>
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="idno" placeholder="Eg 3178...">
                    </div>
                  </div> <br>
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="cname" placeholder="John Doe">
                    </div>
                  </div> <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="phoneno" value="7" >
                    </div>
                  </div> <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="altphone" value="7">
                    </div>
                  </div> <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="email" placeholder="someone@......">
                    </div>
                  </div> <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="paddr" placeholder="P.O Box ......">
                    </div>
                  </div> <br>
                    ...
                    <div class="col-sm-9">
                      <input id="form-control-3" class="form-control" type="text" name="town" placeholder="Nairobi/Mombasa">
                    </div>
                  </div> <br>
