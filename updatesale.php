...
// //sold cars table
$query1="UPDATE soldcars SET chasis = '$chasis',datesold = '$datesold', sellingprice='$sellingprice', deposit='$deposit',balance='$balance',installmentamount='$installmentamount',duedate='$duedate' WHERE soldcars.chasis = '$chasis'";
...
// //client table
$query2="UPDATE customer SET idno = '$client_idno', cname = '$cname', phoneno = '$phoneno', email = '$email' WHERE customer.idno = '$client_idno'";
